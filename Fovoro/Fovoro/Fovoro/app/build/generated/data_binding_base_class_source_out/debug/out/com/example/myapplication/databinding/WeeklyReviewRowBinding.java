...
public final class WeeklyReviewRowBinding implements ViewBinding {
  ...
  private WeeklyReviewRowBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView descriptionView, @NonNull ImageButton likebutton,
      @NonNull TextView likecount, @NonNull ImageView recyclerimg, @NonNull TextView titleView) {
  ...
  public static WeeklyReviewRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WeeklyReviewRowBinding((ConstraintLayout) rootView, descriptionView, likebutton,
